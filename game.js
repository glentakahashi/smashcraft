function Game(stageNum,players,p1,p2,p3,p4) {
  ...
  switch(stageNum) {
	...
	case 7:
		...
		self.platforms.push(new Platform(vec3.fromValues(6.0, 1.0, 6.0), vec3.fromValues(0.0, 14.0, -14.0), "Trans", 'lava', 2));
		self.platforms.push(new Platform(vec3.fromValues(6.0, 1.0, 6.0), vec3.fromValues(0.0, 14.0, 14.0), "Trans", 'lava', 2.5));
